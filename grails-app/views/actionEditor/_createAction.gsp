...
<g:form action="createAction">
    ...
    <g:select name="actionTypeClass" onchange="actionTypeChanged(this)" noSelection="['':'-Choose Action-']" from="${['NpcAction','MapTransition', 'PvpSelectAction', 'ComputerAction', 'MapMessage', 'MarketAction', 'RecoverAction', 'BoulderAction', 'BushAction', 'FindItemAction', 'PersonAction', 'MessagePersonAction','PokemonAction']}" />
