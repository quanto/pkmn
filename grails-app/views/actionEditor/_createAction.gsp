...
<g:form action="createAction">
    ...
    <g:select name="actionType" onchange="actionTypeChanged(this)" noSelection="['':'-Choose Action-']" from="${['NpcAction','MapTransition', 'ComputerAction', 'MapMessage', 'MarketAction', 'RecoverAction']}" />
